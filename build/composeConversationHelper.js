...
/**
 * FarolChat: Modified createNewContact to accept an optional customName parameter.
 * When customName is provided, it is used as the contact name regardless of the input type.
 */
export const createNewContact = async (input, customName = null) => {
  ...
  const payload = {
    ...
    ...(isPhone ? { phone_number: input } : { email: input }),
  };
